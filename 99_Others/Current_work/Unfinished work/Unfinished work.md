...
2022 closed with a flurry of Matter-compliant product launches from a range of large and small businesses

-   Meaningful collaboration seems to be taking hold compared to "go-it-alone" strategies
    
-   Several other corporate developments over the course of 2022 point to a growing sense of commercial and strategic realism about the IoT market.
...
-   The decision to stay or exit the IoT market is an increasingly real challenge for large and vested players
    
-   How do they grasp the opportunities and stay in the market for long enough to make solid commercial returns?
    
-   Amazon is one organization that is playing on multiple strands spanning connectivity, cloud infrastructure, developers and IoT data
    
-   Over the course of 2022, it launched initiatives in support of the Matter protocol and the smart home opportunity.
    
-   Another initiative involved Amazon Sidewalk which operates a long-range, low-power IoT network using Bluetooth and LoRa radios built into Echo and Ring devices
    
-   AWS is also helping 1NCE expand the global reach of its IoT platform by co-developing software that speeds up global deployment of IoT projects
    
-   Vodafone focuses on cellular connected IoT devices, offering customers a global network supported over its home-grown IoT platform
    
-   It also added to its healthcare sector activities by partnering with Proximie to 'digitize operating and diagnostic rooms' through 5G, IoT and edge computing infrastructure
...
-   The IoT industry's ever positive narrative of vertical-sector entry and market expansion experienced several major setbacks over 2022
    
-   Thales selling its unit to Telit to create a new entity, Telit Cinterion
    
-   Google's decision to exit the IoT platform business and withdraw customer support
    
-   Ericsson's December decision to transfer its IoT Accelerator and Connected Vehicle Cloud activities to Aeris
    
-   IBM plans to retire its Watson IoT platform service
...
-   The pendulum might be shifting to the demand side of the industry now that IoT technologies are mature and better understood.
    
-   Specialist users might be taking matters into their own hands by acquiring companies such as Senseye to capitalize on industrial IoT opportunities.
...
-   The arrival of 5G networks and technology is providing impetus to the market for private mobile networks
    
-   5G is also associated with enhanced mobile broadband (eMBB) and ultra-reliable low latency communications (URLLC) use cases.
    
-   Now, there is growing activity in the less well addressed area of massive machine type communications (mMTC).
    

### 

Quectel Wireless Solutions, a global IoT solutions provider, is demonstrating its smart module capabilities with compute-intensive and edge intelligence applications.

-   The SG865W-WF smart module showcases how future use cases of industrial applications, digital signage, unattended retail, fleet management and healthcare can be enabled with edge intelligence and machine vision functionality
    
-   Uses Qualcomm QCS8250 system-on-chip
    
-   Edge computing delivers the real-time analysis needed to identify defects
---
